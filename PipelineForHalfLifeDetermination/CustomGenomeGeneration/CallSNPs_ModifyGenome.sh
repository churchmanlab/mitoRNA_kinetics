...
bcftools mpileup -Ou -f $infasta $inbam1p $inbam2p $inbam4p $inbam5p | bcftools call -mv -Ov -o ${Celline}_${MapMethod}_snpcalls.vcf # Did not finish in 12 hours with all 8 bams
