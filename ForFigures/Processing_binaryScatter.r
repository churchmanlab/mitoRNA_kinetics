...
Set = 'mito_enrich' # tot mito_enrich


PK <- data.table(read.table('/Users/Mary/Desktop/Data/TimelapseSeq/Processing/Processing_Mary.txt', sep="\t",header=TRUE, stringsAsFactors=FALSE))
# Processing_kinetics.txt has an error
...
plot(x,y, type='n', xlim = c(0, 5), xaxt='n', xlab='', ylab="Half-life (min) of unprocessed", main=Set, ylim=c(0,40))
