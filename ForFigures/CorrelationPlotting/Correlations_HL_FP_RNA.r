...
HL1 <- data.table(read.table('/Users/Mary/Desktop/Data/TimelapseSeq/Hela_TL3_2020_09/HalfLife/TL3_MT_t5MTMMinformed6_modeAll_PcMTnorRNA_FracNew_halflives_corr_100000min_v2.txt', sep='\t',header=TRUE, stringsAsFactors=FALSE))

HL2 <- data.table(read.table('/Users/Mary/Desktop/Data/TimelapseSeq/Hela_TL4_combined/HalfLife/TL4_MT_t5MTMMinformed6_modeAll_PcMTnorRNA_FracNew_halflives_corr_100000min_v2.txt', sep='\t',header=TRUE, stringsAsFactors=FALSE))
...
# Calculate correlation coefficients without RNR2
xnor = x[genes != 'MT-RNR2']
ynor = y[genes != 'MT-RNR2']
pearson_rnor = cor.test(~xnor+ynor, method = c('pearson')) 
r2nor = (pearson_rnor$estimate)^2
mylabelnor = bquote(italic(R)^2 == .(format(r2nor, digits = 3)))
...
# Save plot
if (log == 'no') {
pdf(paste0('/Users/Mary/Desktop/Data/TimelapseSeq/Comparisons/Abundance',count,'_vs_HL_dt100000min_RNR2',RNR2,'_SDbars.pdf'), width = 3, height = 3.5)}
if (log == 'yes') {
pdf(paste0('/Users/Mary/Desktop/Data/TimelapseSeq/Comparisons/Abundance',count,'_vs_HL_dt100000min_RNR2',RNR2,'_SDbars_log.pdf'), width = 3, height = 3.5)}
...
text(3, max(limits)*(4/5), labels = mylabel, cex = .8)
text(3, max(limits)*(.5/5), labels = mylabelnor, cex = .8)
...
# source('/Users/Mary/Desktop/Data/TimelapseSeq/Scripts/ForFigures/CorrelationPlotting/Correlations_HL_FP_RNA.R')
